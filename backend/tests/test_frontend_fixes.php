...
assertTest("styles.css define separacion dinamica para WhatsApp con banner activo (--qcs-terms-height)", strpos($stylesContent, '--qcs-terms-height') !== false && strpos($stylesContent, 'body.has-terms-banner') !== false);
...
assertTest("Tarjeta de terminos no solapa a WhatsApp gracias a elevacion dinamica con calc()", strpos($stylesContent, 'calc(var(--qcs-terms-height') !== false);
