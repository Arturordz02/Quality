            ...
            <div class="cta-container">
                <div class="cta-box">
                    <div class="cta-content">
                        <span class="cta-tag"><i class="fa-solid fa-sitemap"></i> Formación y Asesoría Especializada en PMO</span>
                        <h3 class="animate__animated animate__fadeInUp animate__delay-1s">Capacita a tu equipo en la gobernanza y gestión de PMO con estándares globales</h3>
                        <p>
                            Diseñamos programas 'In-House' y asesoramos a organizaciones en la adopción de metodologías y mejores prácticas para Oficinas de Gestión de Proyectos alineadas a sus metas estratégicas.
                        </p>
