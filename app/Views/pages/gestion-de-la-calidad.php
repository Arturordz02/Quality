                        ...
                        <div class="pmo-levels-grid" style="margin-top: 1.25rem;">
                            <div class="pmo-card">
                                ...
                                <div class="pmo-card-body">
                                    <h4 class="pmo-card-title">Criterios de Inspección In Situ</h4>
                                    <p class="pmo-card-desc">Orientación técnica en tolerancias constructivas y contrastación física frente a planos vigentes.</p>
                                </div>
                            </div>
                            <div class="pmo-card">
                                <div class="pmo-card-icon"><i class="fa-solid fa-folder-closed"></i></div>
                                <div class="pmo-card-body">
                                    <h4 class="pmo-card-title">Estructuración del Dossier</h4>
                                    <p class="pmo-card-desc">Pautas para el armado progresivo del expediente técnico final y entrega fluida al cliente.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pillars-2x2-grid">
                    ...
                    <div class="pillar-card">
                        ...
                        <div class="pillar-content">
                            ...
                            <p class="pillar-desc">
                                Asesoría en estandarización de procesos, formulación de planes de calidad (PAQ) y diseño de formatos de control útiles, adaptados a la realidad de la obra.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="pillar-card">
                        ...
                        <div class="pillar-content">
                            ...
                            <p class="pillar-desc">
                                Metodología estructurada de análisis de causa raíz ante no conformidades, orientación en acciones correctivas y registro de lecciones aprendidas.
                            </p>
                        </div>
                    </div>
